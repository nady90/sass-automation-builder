...
-- CreateTable
CREATE TABLE "LocalGoogleCredentials" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "LocalGoogleCredentials_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "DiscordWebhook" (
    "id" TEXT NOT NULL,
    "webhooId" TEXT NOT NULL,
    "url" TEXT NOT NULL,
    "name" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "LocalGoogleCredentials_accessToken_key" ON "LocalGoogleCredentials"("accessToken");

-- CreateIndex
CREATE UNIQUE INDEX "LocalGoogleCredentials_channelId_key" ON "LocalGoogleCredentials"("channelId");

-- CreateIndex
CREATE UNIQUE INDEX "LocalGoogleCredentials_userId_key" ON "LocalGoogleCredentials"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "DiscordWebhook_webhooId_key" ON "DiscordWebhook"("webhooId");
...
-- AddForeignKey
ALTER TABLE "LocalGoogleCredentials" ADD CONSTRAINT "LocalGoogleCredentials_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DiscordWebhook" ADD CONSTRAINT "DiscordWebhook_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Slack" ADD CONSTRAINT "Slack_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Connections" ADD CONSTRAINT "Connections_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Workflows" ADD CONSTRAINT "Workflows_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
